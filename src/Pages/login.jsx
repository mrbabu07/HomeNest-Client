...
//                   type="button"
//                   onClick={() => {
//                     emailInputRef.current.value = "demo@homenest.com";
//                     // Optional: auto-fill password (not recommended for security, but common in demos)
//                     // document.querySelector('input[name="password"]').value = "demo123";
//                     toast.info("Demo credentials loaded: demo@homenest.com");
//                   }}
//                   className="w-full py-2.5 px-4 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg font-medium hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
//                 >
//                   Use Demo Account
//                 </button>
//               </div>
      ...
      <div className="min-h-screen bg-base-200 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-base-100 rounded-2xl shadow-2xl overflow-hidden border border-base-300">
          ...
          <div className="bg-gradient-to-r from-primary to-secondary p-6 text-center">
            ...
            <h2 className="text-xl font-semibold text-primary-content">Welcome Back</h2>
            <p className="text-primary-content/80 mt-2">Sign in to your account</p>
          </div>
